...
class ChainObjective3(SyntheticTreeObjective):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        ef = ef.at[20,500:550].set(jnp.arange(1, 50+1) * (2. / 50.)) # linear edge function
        edge_functions = {
            edges[0]: ef,
        }
        ...
        self.obj_name = "ChainObjective3"

        self.best_x = jnp.array([20, 549])
