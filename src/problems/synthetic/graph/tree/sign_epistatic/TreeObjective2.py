...
class SE_TreeObjective2(SyntheticTreeObjective):
    """
    Implementation of a specific tree objective with L=4, D=20.
    ...
    def __init__(self, *args, **kwargs):
        ...
        for edge in edges:
            ...
            # effect_size = np.random.choice(range(2, 5))
        ...
        self.obj_name = "SE_TreeObjective2"
