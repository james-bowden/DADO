...
class SE_TreeObjective7(SyntheticTreeObjective):
    """
    Implementation of a specific tree objective with L=100, D=20.
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Generate a random tree structure with L-1 edges
        edges = []
        for node in range(1, L):
            parent = np.random.randint(0, node)  # Choose a random parent from existing nodes
        ...
        self.obj_name = "SE_TreeObjective7"
